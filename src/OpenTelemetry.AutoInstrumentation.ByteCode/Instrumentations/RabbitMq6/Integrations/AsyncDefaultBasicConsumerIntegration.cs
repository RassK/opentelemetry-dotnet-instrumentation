...
using OpenTelemetry.AutoInstrumentation.ByteCode.Instrumentations.RabbitMq6.DuckTypes;
using OpenTelemetry.AutoInstrumentation.CallTarget;
using OpenTelemetry.AutoInstrumentation.Util;
// ReSharper disable ConditionIsAlwaysTrueOrFalseAccordingToNullableAPIContract

namespace OpenTelemetry.AutoInstrumentation.ByteCode.Instrumentations.RabbitMq6.Integrations;
