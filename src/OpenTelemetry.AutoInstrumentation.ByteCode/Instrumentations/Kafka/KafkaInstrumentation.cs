...
using OpenTelemetry.AutoInstrumentation.ByteCode.Instrumentations.Kafka.Integrations;
using OpenTelemetry.AutoInstrumentation.DuckTyping;
using OpenTelemetry.Context.Propagation;

namespace OpenTelemetry.AutoInstrumentation.ByteCode.Instrumentations.Kafka;
